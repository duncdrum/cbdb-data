...
## Module URI
[http://exist-db.org/apps/cbdb-data/templates](/db/apps/cbdb-data/modules/app.xql)
...
## Variables:
*   *$app:modules* - *missing description*

## Function Summary

### app:make-func-doc
```xQuery
declare function app:make-func-doc($modules as xs:anyURI*) as item()*
```
...
#### Parameters:
*   $modules - the xQuery modules containing the annotation.
...
:----|:----
<http://exist-db.org/apps/cbdb-data/templates>|[app:report-transform](#app:report-transform)

### app:report-transform
```xQuery
declare function app:report-transform($nodes as node()*) as item()*
```
...
*Module URI*|*Function Name*
:----|:----
<http://exist-db.org/xquery/docs>|[docs:cardinality](#docs:cardinality)
...
## Module URI
[http://exist-db.org/apps/cbdb-data/bibliography](/db/apps/cbdb-data/modules/bibliography.xql)

## Module Description
The bibliography module transforms core bibliographic data from CBDB into TEI. It's output references the taxonomy generated by the genre module. This module deals with core bibliographical data from CBDB. It's elements are frequently referenced by source attributes across the whole data set.
*   Author: Duncan Paterson
*   Version: 0.7
*   [see](#genre)
...
## Module URI
[http://exist-db.org/apps/cbdb-data/biographies](/db/apps/cbdb-data/modules/biographies.xql)
...
## Module URI
[http://exist-db.org/apps/cbdb-data/genre](/db/apps/cbdb-data/modules/genre.xql)
...
## Module URI
[http://exist-db.org/apps/cbdb-data/global](/db/apps/cbdb-data/modules/global.xqm)
...
## Module URI
[http://exist-db.org/apps/cbdb-data/officeA](/db/apps/cbdb-data/modules/officeA.xql)
...
## Module URI
[http://exist-db.org/apps/cbdb-data/place](/db/apps/cbdb-data/modules/place.xql)
