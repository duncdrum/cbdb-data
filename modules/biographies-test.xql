...
:)
let $output-test := doc('/db/apps/cbdb-data/target/listPerson/chunk-01/block-0001/cbdb-0000001.xml')/*/*
...
let $chunk := xmldb:create-collection("/db/apps/cbdb-data/samples/test", 
...
let $person := <person xml:id="{concat('BIO', $individual/text())}">
    {$output-test}
    </person>
