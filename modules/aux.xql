...
let $date_ZH := string-join(($dy/../c_dynasty_chn/text(), 
                    $motto/../c_nianhao_chn/text(),
                    $num/text()), 
                '-')
...
(:for $dy in $DYNASTIES//c_dy[. = 13]
for $motto in $NIAN_HAO//c_nianhao_id[. = 470]
...
return
 ...
 return           
(: string-join(
                (functx:words-to-camel-case(functx:substring-before-match($DYNASTIES//c_dy[. = 13]/../c_dynasty/text(), '\s\(')),
                $NH-py($NIAN_HAO//c_nianhao_id[. = 470]/../c_nianhao_chn/text()), 
                '3'),
            '-')  :)         
            

local:custodate($DYNASTIES//c_dy[. = 13],  $NIAN_HAO//c_nianhao_id[. = 470], 3, 'notBefore' )
