...
(:~
 The bibliography module tranforms bibliographic data from cbdb into tei format. 
...
(:~ 
bib:roles reads c_role_id from TEXT_DATA, and TEXT_ROLE_CODES to transfomr into matching TEI elements.
...
@return author, editor, or pubisher with pointers to listPerson.
:)
...
(:2188.5s:)
declare function bib:write ($item as item()*) as item() {
